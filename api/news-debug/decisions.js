import { getDecisions } from "../_lib/newsDebugLog.js";

/**
 * GET /api/news-debug/decisions
 *
 * Returns decision entries from KV.
...
export default async function handler(req, res) {
  ...
  try {
    ...
    const items = await getDecisions(parsedLimit);
    ...
    console.error("[news-debug/decisions] Error:", error);
    return res.status(500).json({
      ok: false,
